README.md 0x08. Networking basics #1 Table of contents Files Description 0-change_your_home_IP Write a Bash script that configures an Ubuntu server with the below requirements.
